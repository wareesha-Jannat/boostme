...
const Creation = ({ creation, onEdit, onDelete, showActions }) => {
  return (
    <div className="bg-gray-900 rounded-2xl w-[320px]   overflow-hidden shadow-md hover:shadow-lg flex flex-col relative hover:scale-105 transform transition-transform duration-500 ">
      {showActions && (
